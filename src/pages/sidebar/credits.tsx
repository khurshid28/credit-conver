...
import CreditsTable from "../../components/sidebar tables/tables/creditsTable";
...
export default function CreditsPage() {
  ...
  let emptyCredit: Credit = {
    createdAt: new Date(),
    ball: 100,

  };
  let [Credit, setCredit] =
    useState<Credit>(emptyCredit);
