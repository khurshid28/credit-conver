import {
  ...
  import { ScoringContract } from "../../../pages/sidebar/scoring-contracts";
  ...
  export default function ScoringContractsTable() {
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  {/* <div>
                    ...
                    <Select
                      ...
                      className="dark:bg-dark-900"
                      defaultValue={`${ScoringContract.section_id}`}
                      onChange={() => {}}
                    />
                  </div> */}
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value={ScoringContract.user?.code}
                      onChange={(e) =>
                        setScoringContract({
                          ...ScoringContract,
                          user: {
                              ...ScoringContract.user,
                              code: e.target.value,
                          },
                        })
                      }
